...
<div id="content">
	...
	if ($action == 'process') {
		...
		dinstaller_log("secure build name: 50898124546ce5276_copia_para_desenvolvimento_mahmoud");
		dinstaller_log("----------------------------------");
