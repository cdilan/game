...
function pagelines_pagination() {
	...
	elseif (show_posts_nav()) : ?>
		<div class="page-nav-default fix">
			<span class="previous-entries"><?php next_posts_link(__('&larr; Posts anteriores','pagelines')) ?></span>
			<span class="next-entries"><?php previous_posts_link(__('Posts recentes &rarr;','pagelines')) ?></span>
		</div>
<?php endif;
}
