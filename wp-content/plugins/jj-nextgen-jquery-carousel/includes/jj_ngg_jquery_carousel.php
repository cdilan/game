    ...
    {         
      ...
      if($width != '' && $height != '')
      {
        ...
        if($vertical == '' || $vertical == 'false')
        {
          ...
          $output .= "\n  div#" . $html_id . "_container ." . $skin_class . " .jcarousel-container-horizontal { width: " . 710 . "px !important; }";
          $output .= "\n  div#" . $html_id . "_container ." . $skin_class . " .jcarousel-clip-horizontal { width: " . 710 . "px !important; height: " . 80 . "px !important; }";          
          $output .= "\n  div#" . $html_id . "_container ." . $skin_class . " .jcarousel-next-horizontal { top: " . 38 . "px !important; }";
          $output .= "\n  div#" . $html_id . "_container ." . $skin_class . " .jcarousel-prev-horizontal { top: " . 38 . "px !important; }";          
          if($gap != '')
          {
      ...
      foreach($results as $result) 
      {
        ...
        if($use_url)
        {
          $output .= "<a class=\"fancybox\" target=\"_blank\" href=\"" . esc_attr($image_alt) . "\">";
        }
