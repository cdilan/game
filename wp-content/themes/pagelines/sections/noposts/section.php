...
class PageLinesNoPosts extends PageLinesSection {
   ...
   function section_template() { ?>
	...
	<?php else: ?>
				...
				<h2 class="notfound-splash center"><?php _e('Página não encontrada','pagelines');?></h2>
				<p class="subhead center"><?php _e('Desculpe, mas esta página não existe.', 'pagelines');?><br/><?php _e('Você pode ir para','pagelines');?> <a href="<?php echo home_url(); ?>"><?php _e('home page','pagelines');?></a> <?php _e('ou fazer uma busca abaixo!', 'pagelines');?></p>
